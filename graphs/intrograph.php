...
function drawIndexChart(){
  ...
  oReq.onreadystatechange = function() {
      if (oReq.readyState == XMLHttpRequest.DONE) {
          ...
          var chart = new CanvasJS.Chart("intro-results",{
            title: {
            },
            axisY: {
              suffix: " %"
      ...
      document.getElementById("intro-results").innerHTML = '<h2 style="align:center; padding:6px;display:block; color:white; background:#c06">To get results, use the 5 intro cards directly above.</h2>';
    }
  }
}
  oReq.open("GET", "graphs/get-data-both.php?category=" + category, true);
  oReq.send();
}
